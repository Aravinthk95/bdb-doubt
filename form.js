...
var parent8=document.createElement('div');
parent8.setAttribute('id','pair8');
subcontainer.append(parent8);

let buto=document.createElement('button');
buto.setAttribute('type','button');
buto.setAttribute('class','butno');
buto.setAttribute('placeholder','submit');
...
// let buto =document.getElementsByClassName('butno');
// buto.addEventListener("click", () => {
//     let firstname=document.getElementsByClassName('mail').value;
//     let lastname=document.getElementsByClassName('pas').value;
//     let address=document.getElementsByClassName('addres').value;
//     let pincode=document.getElementsByClassName('no').value;
//     let state=document.getElementsByClassName('find').value;
//     let country=document.getElementsByClassName('nation').value;
//     let gender=document.getElementsByClassName('gene').value;
//     let male=document.getElementsByClassName('mel').value;
//     let female=document.getElementsByClassName('fell').value;
//     let foods=document.getElementsByClassName('fod').value;
//     let meals=document.getElementsByClassName('item1').value;
//     let biriyani=document.getElementsByClassName('item2').value;
//     let meat=document.getElementsByClassName('item3').value;
//     let chiken=document.getElementsByClassName('item4').value;
//     let chappati=document.getElementsByClassName('item5').value;
    

//     if(firstname.type=word) {
